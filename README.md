# project-credix-hydrasoft

## 🚀 Sistema de Información Web para el Control y Gestión de Créditos (Credix)
**Desarrollado por:** HydraSoft
...
* **Backend:** Python 3.10+
* **Arquitectura:** Cliente/Servidor (API RESTful basada en JSON)
* **Control de Versiones:** Git & GitHub

## 📂 Estructura Inicial del Proceso Misional
El flujo base del sistema de información contempla el siguiente ciclo de operación:
1. Registro e indexación del perfil del deudor mediante validación de documento de identidad.
